...
public class Dico {
	...
	public static final Hashtable<String, String> dico_allemand = new Hashtable<String,String>() {{
		...
		put("Ajouter une course",    "Ein Rennen hinzufugen");
		...
		put("Ajouter une voiture",    "Ein Auto hinzufugen");
		...
		put("Pilote au depart :",    "Zunachst Rennfahrer");
		put("Ajouter un pilote",    "Ein Rennfahrer hinzufugen");
		put("Informations sur le pilote",    "Informationnen auf der Rennfahrer");
		put("Nom",    "Name");
		put("Couleur du casque",    "Helm Farbe");
		put("Ajouter / Modifier",    "Hinzufugen / ");
		...
		put("Duree totale maximum par pilote :",    "Total maximal Zeit fur einen Rennfahrer");
		put("Duree consecutive maximum par pilote :",    "Maximal Konsecutiv Zeit fur einen Rennfahrer");
		put("Commentaires sur la course :",    "Kommentar auf der Renn");
		put("Informations concernant l'essai",    "Informationnen uber den Test");
		put("Informations concernant la course",    "Informationnen uber der Renn");
		put("Fichier",    "Datei");
		put("Edition",    "Ausgabe");
		put("Vue",    "Ansicht");
		put("Aide",    "Hilfe");
		...
		put("STOP",    "STOP");
		put("Informations pilotes",    "Informationnen uber dem Rennfahrer");
	...
	public static final Hashtable<String, String> dico_francais = new Hashtable<String,String>() {{
		...
		put("Francais",    "Francais");
		put("Allemand",    "Allemand");
		put("Anglais",    "Anglais");
		put("Valider",    "Valider");
		put("Creer une course",    "Creer une course");
		...
		put("Retour",    "Retour");
		put("Course",    "Course");
		put("Caracteristiques",    "Caracteristiques");
		...
		put("Seance d'essai",    "Seance d'essai");
		...
		put("Attention ! Tous les tops associes seront supprimes",    "Attention ! Tous les tops associes seront supprimes.");
		put("Ajouter une voiture",    "Ajouter une voiture");
		put("Numero de la voiture",    "Numero de la voiture");
		put("Couleur",    "Couleur");
		put("Lien vers l'image",    "Lien vers l'image");
		put("Voiture active",    "Voiture active");
		put("Nombre de tour(s)",    "Nombre de tour(s)");
		put("Temps estime par tour",    "Temps estime par tour");
		...
		put("Caracteristiques de l'essai",    "Caracteristiques de l'essai");
		put("Heure de debut :",    "Heure de debut :");
		put("Heure de fin :",    "Heure de fin :");
		put("Depart automatique",    "Depart automatique");
		...
		put("Duree totale maximum par pilote :",    "Duree totale maximum par pilote :");
		put("Duree consecutive maximum par pilote :",    "Duree consecutive maximum par pilote :");
		...
		put("Temps",    "Temps");
		put("Heure",    "Heure");
		put("Temps ecoule depuis le depart",    "Temps ecoule depuis le depart");
		...
		put("Nombre de tours effectues",    "Nombre de tours effectues");
